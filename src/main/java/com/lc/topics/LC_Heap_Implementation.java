package com.lc.topics;

//Implementing "Min Heap"
public class LC_Heap_Implementation {
 ...
 public LC_Heap_Implementation(int heapSize) {
 ...
 public static void main(String[] args) {
     // Test case
	 LC_Heap_Implementation minHeap = new LC_Heap_Implementation(3);
     minHeap.add(3);
     minHeap.add(1);
     minHeap.add(2);
     // [1,3,2]
